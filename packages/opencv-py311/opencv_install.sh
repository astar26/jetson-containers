...
PYTHON3_VERSION=`python3.11 -c 'import sys; version=sys.version_info[:3]; print("{0}.{1}".format(*version))'`
...
python3.11 -c "import cv2; print('OpenCV version:', str(cv2.__version__)); print(cv2.getBuildInformation())"
